...
@SourceType(value = "GoogleAdsARP", label = "GoogleAds",uiConfig = "googleads-layout.json")
public class GoogleAdsConf extends AbstractArpConf<GoogleAdsConf> {
  private static final String ARP_FILENAME = "arp/implementation/googleads-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googleads.GoogleAdsDriver";
